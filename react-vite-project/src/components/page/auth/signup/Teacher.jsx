...
const Teacher = ({fieldClass, labelClass, errorClass, eyeClass, serverErrorClass, passwordHintClass, submitClass}) => {
        ...
        try {
            ...
            switch (response.status) {
                case 409: {
                    ...
                    if (conflictField === 'teacherId') {
                        setWarnings(w => ({...w, teacherId: 'This teacher ID is already in use.'}));
    ...
    return (
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <MatriculeField
                value={form.teacherId} onChange={handleChange} warning={warnings.teacherId}
                labelClass={labelClass} errorClass={errorClass} fieldClass={fieldClass}
                name="teacherId"
                role="Teacher"
            />
