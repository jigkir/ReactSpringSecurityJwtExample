    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-left space-y-3">
            ...
            <div className="flex flex-wrap gap-2 text-md text-gray-500 pt-1 border-t border-gray    -100">
                <span className="bg-gray-100 px-2.5 py-1 rounded flex items-center gap-1.5">
                ...
                <span className="bg-gray-100 px-2.5 py-1 rounded flex items-center gap-1.5">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6v3m0 3h.008v.008H12v-.008Z" />
                    </svg>
                    {internship.deadline}
                </span>
                <button
                    className="p-1.5 rounded hover:bg-gray-200 ml-auto text-gray-600 hover:text-red-600 transition-colors"
